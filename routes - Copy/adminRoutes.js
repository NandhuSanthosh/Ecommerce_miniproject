const {
  ...
  delete_category,
  patch_updateRequest,
  get_complete_userDetails,
  get_forgotPassword,
  post_forgotPassword,
  get_resetPassword,
  post_resetPassword,
  get_user_serach_result,
  get_category_serach_result,
  get_all_categories,
  get_dashboard_details,
  get_dashboard_monothy,
  get_report_data,
...
const {
  ...
  parser,
  isAwaitingOtp,
} = require("../Middleware/adminAutherization");
...
const {
  ...
  put_activate_coupon,
  put_activateCoupon,
  put_deactivateCoupon,
  get_coupons,
  get_coupons_search_result,
...
router.get("/get_report_data", isLogged, get_report_data);
