...
exports.sendPasswordResetMail = function (name, link, userEmail) {
  ...
  var email = {
    body: {
      name: name,
      intro:
        "We received a request to reset you account password.To reset your password, please click the button below:",
      action: {
      ...
      outro:
        "This link is valid for 10 minutes to ensure your account's security. Change you password within the time limit",
    },
  };
